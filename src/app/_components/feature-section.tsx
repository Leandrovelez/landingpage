...
export default function FeatureSection(){
    return(
        <section 
            id="feature" 
            className="bg-slate-50 dark:bg-transparent w-10/12 space-y-6 py-8 md:py-12 lg-py-24 px-8 rounded-lg">
            <div className='mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center'>
                <h2 className="font-leading text-3xl leading-[1.1] sm:text-3xl md:text-6xl">
                    Stacks
                </h2>
                <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                    A lista de stacks que conheço, estudo e uso no dia-a-dia do trabalho.
                </p>
            </div>
